...
1. Download and extract the repository files: Use the command "git clone https://github.com/solanasniperdev/Raydium-Solana-Sniper-Bot.git" or click the green "Code" button and select "Download ZIP".
...
## CONTACT
Discord: `@solanasniperdev` 

## DISCLAIMER

> [!IMPORTANT]
> Sniping is not for everyone, use at your own risk.
